...
function hamburger(x) {
    if (x.classList.contains("change")) {
        document.querySelectorAll('.hamburger__container').forEach(hamburger => {hamburger.classList.remove("change")})
        document.querySelectorAll('#fixed-menu').forEach(menu => {menu.classList.add('hidden')})
        document.querySelector("#overlay").classList.add('hidden')
    } else {
        document.querySelectorAll('.hamburger__container').forEach(hamburger => {hamburger.classList.add("change")})
        document.querySelectorAll('#fixed-menu').forEach(menu => {menu.classList.remove('hidden')})
